...
define('MENU_TITLE', 'CityBook Options'); 
define('MENU_SLUG', 'citybook');
...
add_menu_page(__(MENU_TITLE), __(MENU_TITLE), 'administrator',  MENU_SLUG, array(&$this, 'acera_display_page'), 'dashicons-admin-tools', 2); }

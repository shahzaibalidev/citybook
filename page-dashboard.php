            ...
            <div class="container">
                ...
                <div class="profile-edit-wrap">
                    <div class="profile-edit-page-header">
                        <h2>Admin Panel</h2>
                        <div class="breadcrumbs"><a href="<?php echo site_url(); ?>">Home</a><span>Dasboard</span></div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="fixed-bar fl-wrap">
                                <div class="user-profile-menu-wrap fl-wrap">
                                    ...
                                    <div class="user-profile-menu">
                                        <h3>Main</h3>
                                        <ul>
                                        	<li><a href="<?php echo site_url(); ?>/dashboard" class="user-profile-act"><i class="fa fa-gears"></i>Dashboard</a></li>
